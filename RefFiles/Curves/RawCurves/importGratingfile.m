function Littrow111 = importGratingfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   LITTROW111 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   LITTROW111 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Littrow111 = importfile('Littrow-111.dat', 1, 448);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/12/06 11:17:41
