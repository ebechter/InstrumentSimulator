...
%Thorlabs curves
[output] = importThorlabsData('C_Broadband_AR-Coating.xlsx');
e = size(output,1);
e = 113;
c_coating(:,1) = flipud(output(2:e-2,3));
c_coating(:,2) = flipud(output(2:e-2,4)./100);

save('c_coating.mat','c_coating')
