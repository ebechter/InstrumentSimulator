...
testwfe = 0;%linspace(1/100,0.5,10);
pathprefix = pwd;
...
%     wfe(15)=0;%testwfe(ii);
    ...
    headerinfo = {
        ...
        'Vsini', vsini,' ';...
        'Tlrcs', sources{1}.atmosphere ,'Are tellurics included 1/0';...
        'WFE',testwfe(ii),'wfe in radians';...
        };
    
    
    fname = ['FlatDCNewPSF' num2str(ii)];
    fitsname = [pathprefix,'/Output/Flat/',fname,'.fits'];
